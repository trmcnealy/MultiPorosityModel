...
{
    public class MultiPorosityChartLogLogViewModel : BindableBase
    {
        ...
        public MultiPorosityChartLogLogViewModel(MultiPorosityModelService multiPorosityModelService)
        {
