...
{
    public class RelativePermeabilitiesNaturalFractureChartViewModel : BindableBase
    {
        ...
        public SelectedData[] SelectedRecords
        {
            ...
            set
            {
                ...
                {
                    _multiPorosityModelService.ActiveProject.SelectedRelativePermeabilityNaturalFractureModels.Clear();

                    for(int i = 0; i < selected.Length; ++i)
                    {
                        _multiPorosityModelService.ActiveProject.SelectedRelativePermeabilityNaturalFractureModels.Add(_multiPorosityModelService.ActiveProject.RelativePermeabilityNaturalFractureModels[selected[i].PointIndex]);
                    }
        ...
        public RelativePermeabilitiesNaturalFractureChartViewModel(MultiPorosityModelService multiPorosityModelService)
        {
                                       ...
                                       PropertyChangedEventArgs e)
        {
            switch(e.PropertyName)
            {
                case "ActiveProject":
                {
                    ...
                    _multiPorosityModelService.ActiveProject.PropertyChanged                                             += OnPropertyChanged;
                    _multiPorosityModelService.ActiveProject.RelativePermeabilityNaturalFractureModels.CollectionChanged -= OnRelativePermeabilityModelsChanged;
                    _multiPorosityModelService.ActiveProject.RelativePermeabilityNaturalFractureModels.CollectionChanged += OnRelativePermeabilityModelsChanged;
                    OnRelativePermeabilityModelsChanged(sender, null);

                    break;
                }
                case "RelativePermeabilityNaturalFractureModels":
                {
                    OnRelativePermeabilityModelsChanged(sender, null);
                                                         ...
                                                         NotifyCollectionChangedEventArgs? e)
        {
            ...
            RelativePermeabilityModel[]? relativePermeabilityModelsSoArray = _multiPorosityModelService.ActiveProject.RelativePermeabilityNaturalFractureModels.Where(m => m.Sg == 0.0).ToArray();
            RelativePermeabilityModel[]? relativePermeabilityModelsSgArray = _multiPorosityModelService.ActiveProject.RelativePermeabilityNaturalFractureModels.Where(m => m.So               == 0.0).ToArray();
