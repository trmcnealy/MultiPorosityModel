...
namespace MultiPorosity.Services
{
    ...
    public class Bucket : IComparable<Bucket>, ICloneable
    {
        ...
        /// difference in <c>Count</c> given by.
        /// </remarks>
        public override bool Equals(object obj)
        {
            ...
            return LowerBound.Equals(bucket.LowerBound)
                ...
                && Math.Abs(Count - bucket.Count) < double.Epsilon;
        }
    ...
    public class Histogram
    {
            ...
            : this()
        {
            ...
            double lower = dataArray.Min();
            double upper = dataArray.Max();
            ...
            AddBucket(new Bucket(lower--, fNextLowerBound));
